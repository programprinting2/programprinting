...
@section('content')
  ...
  <nav class="page-breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Siap Diambil</li>
    </ol>
  </nav>
  ...
  <div class="row">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="row">
            <h6 class="card-title mb-0">Data Pekerjaan Siap Diambil</h6>
            <p class="text-muted mb-3">Daftar semua SPK yang siap diambil.</p>
    </div>
          </div>
